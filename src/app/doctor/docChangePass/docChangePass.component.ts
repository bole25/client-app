...
import {DocChangePassService} from './docChangePass.service';

@Component({
  // tslint:disable-next-line:component-selector
  selector: 'app-users',
  templateUrl: './docChangePass.component.html'
})

export class DocChangePassComponent {
  email: string;
  user: User;
  repeatedPassword: string;
  password: string;

  constructor(private router: Router, private route: ActivatedRoute, private service: DocChangePassService) {
    this.user = new User();
